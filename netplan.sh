...
clear
echo "                                  _         _              "
echo "   ___  __ _ ___ _   _ _ __   ___| |_ _ __ | | __ _ _ __   "
echo "  / _ \/ _` / __| | | | '_ \ / _ \ __| '_ \| |/ _` | '_ \  "
echo " |  __/ (_| \__ \ |_| | | | |  __/ |_| |_) | | (_| | | | | "
echo "  \___|\__,_|___/\__, |_| |_|\___|\__| .__/|_|\__,_|_| |_| "
echo "                 |___/               |_|                   "
echo ""
echo "IP & DNS Yapılandırma İşlemleri"
echo ""
...
echo ""
while true; do
    read -p "Are you sure you want to apply the IP & DNS settings? (y/n)" eh
    case $yn in
